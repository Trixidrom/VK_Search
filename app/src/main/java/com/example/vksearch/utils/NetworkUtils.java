...
public class NetworkUtils {
    ...
    public final static String BYEAR = "birth_year";
    public final static String BMONTH = "birth_month";
    public final static String BDAY = "birth_day";
    public final static String AGEFROM = "age_from";
    public final static String AGETO = "age_to";

    public final static String PARAMS = "q";

    public static URL generateURL(String searchString){
        URL url = null;
        return url;
    }
        public static URL generateURL(String searchString, String city, int ageFrom, int ageTo, int bday, int bmonth, int byear){
            ...
            Uri buildUri = Uri.parse(API + METHOD)
                    ...
                    .appendQueryParameter(AGEFROM, Integer.valueOf(ageFrom).toString())
                    .appendQueryParameter(AGETO, Integer.valueOf(ageTo).toString())
                    .appendQueryParameter(BDAY, Integer.valueOf(bday).toString())
                    .appendQueryParameter(BMONTH, Integer.valueOf(bmonth).toString())
                    .appendQueryParameter(BYEAR, Integer.valueOf(byear).toString())
                    .appendQueryParameter(TOKEN,
                            "fbcd883c37916bc8c789870ad0a8938b7583556969342206ed6d3bf4c33b062b143fc452d12f80ad2c9bb")
                    .build();
            if(byear==0){
                buildUri = Uri.parse(API + METHOD)
                        .buildUpon()
                        .appendQueryParameter(COUNT, "1000")
                        .appendQueryParameter(CITY, city)
                        .appendQueryParameter(PARAMS, searchString)
